...
static void SPI2_IS_MASTER(void);
static void SPI2_IS_SLAVE(void);


static void SPI2_CPOL_HIGH(void);
static void SPI2_CPOL_LOW(void);





static void SPI2_CPHA_FIRST(void);
static void SPI2_CPHA_SECOND(void);


static void SPI2_EIGHT_BIT(void);
static void SPI2_SIXTEEN_BIT(void);

static void SPI2_ENABLE_SSM(void);
static void SPI2_DISABLE_SSM(void);

static void SPI2_NSS_HIGH(void);
static void SPI2_NSS_LOW(void);
...
static void SPI2_IS_SLAVE(void){
	(CLEAR_BIT(SPI2->CR1,SPI_CR1_MSTR));
}

static void SPI2_CPOL_HIGH(void){
	(SET_BIT(SPI2->CR1,SPI_CR1_CPOL));
}
...
static void SPI2_CPHA_FIRST(void){
	(CLEAR_BIT(SPI2->CR1,SPI_CR1_CPHA));
}
...
static void SPI2_DISABLE_SSM(void){
	(CLEAR_BIT(SPI2->CR1,SPI_CR1_SSM));
}
